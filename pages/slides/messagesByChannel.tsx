            ...
            <div className='flex items-center justify-items-center h-full w-full'>
                <div className='px-8 text-center w-full'>
                    <h1 className='text-4xl font-black mb-16'>
                        Em <span className='text-azoxo'>2022</span> você enviou <span className='text-azoxo'>{new Intl.NumberFormat('pt-BR').format(mostMessagedChannel.value)}</span><br/>
                        no canal <span className='text-azoxo'>{mostMessagedChannel.key}</span> 
                    </h1>
